...
internal static class ShellRouteRegistrar
{
    ...
    public static void RegisterCommonRoutes()
    {
        ...
        Routing.RegisterRoute(nameof(WartungsvertraegePage), typeof(WartungsvertraegePage));
        Routing.RegisterRoute(nameof(MemberWartungsvertraegePage), typeof(MemberWartungsvertraegePage));
        Routing.RegisterRoute(nameof(WartungsvertragDetailPage), typeof(WartungsvertragDetailPage));
        Routing.RegisterRoute(nameof(WartungsvertragEditorPage), typeof(WartungsvertragEditorPage));
        Routing.RegisterRoute(nameof(WartungsvertragAssignMembersPage), typeof(WartungsvertragAssignMembersPage));
        ...
        Routing.RegisterRoute(nameof(VereinskonfigurationPage), typeof(VereinskonfigurationPage));
        ...
        Routing.RegisterRoute(nameof(ParzellenAblesungenPage), typeof(ParzellenAblesungenPage));
        Routing.RegisterRoute(nameof(AblesungErfassenPage), typeof(AblesungErfassenPage));
        Routing.RegisterRoute(nameof(PendingPhotoUploadsPage), typeof(PendingPhotoUploadsPage));
        ...
        Routing.RegisterRoute(nameof(ParzellenProtokollePage), typeof(ParzellenProtokollePage));
