...
public sealed class MitgliedsantragPreviewPage : ContentPage
{
                    ...
                    new Border
                    {
                        ...
                        Content = new VerticalStackLayout
                        {
                            ...
                            Children =
                            {
                                ...
                                new Label { Text = $"Datei: {_previewUploadRequest.FileName}", TextColor = Colors.Gray, LineBreakMode = LineBreakMode.WordWrap },
                                new Label { Text = "Die vollständige PDF-Vorschau wird über den temporären lokalen Preview-Pfad geöffnet; der offizielle Mitgliedsdokumentpfad wird erst nach erfolgreicher Unterschrift verwendet.", TextColor = Colors.Gray, LineBreakMode = LineBreakMode.WordWrap },
                                openPreviewButton
                            }
                        }
                    },
    ...
    public Task<MitgliedsantragPreviewDecision> WaitForResultAsync() => _resultSource.Task;
