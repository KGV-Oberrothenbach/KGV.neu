...
public sealed class MitgliedsantragTemplateData
{
    ...
    public string VertreterGeburtsdatum { get; set; } = string.Empty;
    ...
    public string MitgliedsbeitragAnteilig { get; set; } = string.Empty;
    public string Beitragsmonate { get; set; } = string.Empty;
