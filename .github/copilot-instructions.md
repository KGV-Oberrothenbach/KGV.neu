...
- Im KGV-Projekt vor Änderungen den realen Repo-/Arbeitsbaumstand und den aktuellen KGV_Fortschrittslog_ausfuehrlich.md prüfen; nur Blockdateien stagen, beide Logdateien fortführen, `dotnet build KGV.Maui/KGV.Maui.csproj` ausführen und am Ende committen und pushen.
...
- Im KGV-Projekt bei Abschlussläufen Git-Operationen über den vorgegebenen Visual-Studio-Git-Pfad `C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\CommonExtensions\Microsoft\TeamFoundation\Git\cmd\git.exe` ausführen und nur die explizit genannten Blockdateien stagen.
