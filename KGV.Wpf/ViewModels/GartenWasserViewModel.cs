...
namespace KGV.ViewModels
{
    public sealed class GartenWasserViewModel : BaseViewModel, INavigationAware
    {
        ...
        public GartenWasserViewModel(ISupabaseService supabaseService, ParzellenBelegungDTO belegung, MainWindowViewModel mainVm)
        {
            _supabaseService = supabaseService;
            Belegung = belegung;
            _mainVm = mainVm ?? throw new ArgumentNullException(nameof(mainVm));

            ZaehlerEinbauenCommand = new RelayCommand<object?>(_ => _ = ZaehlerEinbauenAsync(), _ => PermissionChecks.CanManageMeterChanges(_mainVm.UserContext));
            ZaehlerAusbauenCommand = new RelayCommand<object?>(_ => _ = ZaehlerAusbauenAsync(), _ => PermissionChecks.CanManageMeterChanges(_mainVm.UserContext));
        ...
        {
            ZaehlerEinbauenCommand.RaiseCanExecuteChanged();
            ZaehlerAusbauenCommand.RaiseCanExecuteChanged();
